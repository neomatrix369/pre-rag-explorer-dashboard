...
Also removes blank lines left at the very end of the message.

Usage (called by Husky at commit-msg stage):
    python3 scripts/strip_ai_coauthor.py <path-to-COMMIT_EDITMSG>
"""
