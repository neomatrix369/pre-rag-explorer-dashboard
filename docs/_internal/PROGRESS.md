...
- **Alternative:** Infra Docker static deploy — see [`../slices/SLICE-INFRA-HARDENING.md`](../slices/SLICE-INFRA-HARDENING.md) Phase 5 and [development.md](../contributor-guide/development.md#docker-optional-production-run)
...
### Exit criteria
See [`../slices/SLICE-INFRA-HARDENING.md`](../slices/SLICE-INFRA-HARDENING.md) acceptance criteria checklist (+ Docker exit criteria in Phase 5).
...
- `docs/_internal/PROGRESS.md` — This file
